...
client.on('message', (message) => {
    ...
    if(msg.startsWith(prefix + 'SUGERIR')){
       ...
       if(msg.startsWith(prefix + 'AVISO')){
	    ...
	    if(!message.member.roles.find("name", 'Moderadores')("name", 'Coordenadores')("name", 'Administradores')) return message.channel.sendMessage(":x: | Você não possui permissão").then(msg => {
        })
